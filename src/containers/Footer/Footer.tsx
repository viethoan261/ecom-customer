import { ActionIcon, Container, Group, Stack, Text, createStyles, rem } from '@mantine/core';
import { IconBrandInstagram, IconBrandTwitter, IconBrandYoutube, IconShirt } from '@tabler/icons-react';
  ...
  return (
    <footer className={classes.footer}>
      ...
      <Container className={classes.afterFooter}>
        ...
        <Group spacing={0} className={classes.social} noWrap w={300}>
          <ActionIcon size="lg">
